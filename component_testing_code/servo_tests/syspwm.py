...
if __name__ == "__main__":
    ...
    # The Raspberry Pi 4 Model B has two hardware PWM channels accessible through four GPIO pins: GPIO12, GPIO13, GPIO18, and GPIO19. Specifically, GPIO12 and GPIO18 share the same PWM channel, and GPIO13 and GPIO19 share the other

	#pwm0 is BCM GPIO pin 18 or BCM GPIO pin 12 i.e. physical pins 12 or 32
	#pwm = SysPWM(0)

    #pwm1 is BCM GPIO pin 19 or BCM GPIO pin 13 i.e. physical pins 35 or 33
	pwm = SysPWM(1)
